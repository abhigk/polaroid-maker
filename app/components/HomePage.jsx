      ...
      <div className='px-5 py-10 md:p-24 bg-primary-pink'>
        ...
        <div className='grid grid-cols-1 gap-12 md:grid-cols-3 text-center'>
          <div>
            <Card>
              <CardHeader className='flex justify-center items-center'>
                <div>
                  <Image src={uploadImg} alt='Polaroid Camera' className='h-52 w-36' />
                </div>
              </CardHeader>
              <CardContent>
          ...
          <div>
            <Card>
              <CardHeader className='flex justify-center items-center'>
                <Image src={fileImg} alt='Polaroid Camera' className='h-52 w-52' />
              </CardHeader>
              <CardContent>
          ...
          <div>
            <Card>
              <CardHeader className='flex justify-center items-center'>
                <Image src={downloadImg} alt='Polaroid Camera' className='h-52 w-52' />
              </CardHeader>
              <CardContent>
